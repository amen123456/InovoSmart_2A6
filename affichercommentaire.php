     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Commentaire-page" class="collapse" aria-labelledby="Commentaire-page" data-parent="#side-nav-accordion">
          <li> <a href="commentaire.html">Ajouter Un Commentaire</a> </li>
            ...
            <div class="col-md-12" >
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">affiche d'un commentaire</li>
                </ol>
              </nav>
            </div>
...
<td><form method="POST" action="mailing.php">
  <input type="hidden" value="<?PHP echo $row['id_commentaire']; ?>" name="id_commentaire">
<button type="submit" style="min-width: 10px" class="btn btn-primary " style="width:130px" >  <i class="flaticon-mail" > </i></button>
   </form>
  </td>
