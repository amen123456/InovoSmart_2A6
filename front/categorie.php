...
<?php include "C:/wamp64/www/Integration/controller/ajoutercategorie.php";
            ...
            ?>
                        <div class="timeline-container">
                            <div class="timeline-content">
                                <h2><?PHP echo $row['nomcategorie']; ?></h2>
                                <p><?PHP echo $row['descriptioncategorie']; ?></p>
                            </div>
                        </div>
                        <?PHP
            }
