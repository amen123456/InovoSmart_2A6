     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Reclamation-page" class="collapse" aria-labelledby="Reclamation-page" data-parent="#side-nav-accordion">
          <li> <a href="AjoutReclamation.html">Ajouter Une réclamation</a> </li>
          <li> <a href="ModifierReclamation.html">Modifier Une réclamation</a> </li>
          <li> <a href="SupprimerReclamation.html">Supprimmer Une réclamation</a> </li>
          <li> <a href="AfficherReclamation.php"> Afficher les réclamations</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="Notification-page" class="collapse" aria-labelledby="Notification-page" data-parent="#side-nav-accordion">
          ...
          <li> <a href="../Notification/AfficherNotification.php"> Afficher les Notifications</a> </li>
        ...
        <li class="ms-nav-item ms-search-form pb-0 py-0">
          <form class="ms-form" method="post">
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <label for="cars" color="#ffffff">Search by: </label>
              <select name="search_by" id="search_by">
                <option value="reclamid">ID Commentaire</option>
                <option value="uid">ID Utilisateur</option>
                <option value="dat">Date</option>
                <option value="message">Message</option>
              </select>
              <input type="search" class="ms-form-input" name="search" placeholder="" value="">
              <i class="flaticon-search text-disabled"></i>
              <form action="AfficherCommentaire.php" method="post" style="margin-left: 10px;">
                             <input type="submit" value="Afficher Tous" class="btn btn-primary w-10 mt-0 has-icon">
                             </form>
            </div>
          </form>
        </li>
...
<label for="cars" color="#ffffff">Trier par: </label>
<select name="tri" id="tri">
<option value="reclamid">ID Reclamation</option>
<option value="userid">ID Utilisateur</option>
<option value="date">Date</option>
<option value="msg">Message</option>
</select>
<input type="submit" value="Trier" class="btn btn-primary w-5 mt-0 has-icon">
</form>
    <?php
...
if (!$link)
  ...
  $search_by= mysqli_real_escape_string($link, $_REQUEST['search_by']);
$result = mysqli_query($link, "SELECT * FROM reclam where $search_by = '$search'");
echo "<table border='1' class='table table-hover thead-primary'>
