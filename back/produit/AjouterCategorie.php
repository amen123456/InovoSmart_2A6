...
include_once 'C:/wamp64/www/Integration/controller/ajoutercategorie.php';
                    ...
                    <div>
                        <form method="post" action="">
                            <div class="form-group">
                                <label for="nomcategorie">Modifier le nom de categorie</label>
                                <input type="text" class="form-control" name="nomcategorie" id="nomcategorie" placeholder="Entrer le nomcategorie">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="descriptioncategorie">
                            </div>
                           <!-- <script>
                            CKEDITOR.replace('descriptioncategorie');
                        </script>-->
