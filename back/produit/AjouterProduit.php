...
<?php
include_once 'C:/wamp64/www/Integration/model/produits.php';
include_once 'C:/wamp64/www/Integration/controller/ajouterproduit.php';
                    ...
                    <div>
                        <form method="post" action="">
                            <div class="form-group">
                                <label for="nomproduit">Modifier le nom de produit</label>
                                <input type="text" class="form-control" name="nomproduit" id="nomproduit" placeholder="Entrer le nomproduit">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="nbrproduit">Taper le nouveau nombre des produit</label>
                                <input type="number" class="form-control" name="nbrproduit">
                            </div>

                          
                            <div class="form-group">
                                <label for="imageproduit">Ajouter une nouvelle Image</label>
                                <input type="file" class="form-control-file" name="imageproduit">
                            </div>
                           ...
                           <!-- <script>
                            CKEDITOR.replace('descriptionproduit');
                        </script>-->
