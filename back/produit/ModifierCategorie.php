<?php require_once "C:/wamp64/www/Integration/controller/ajoutercategorie.php"; ?>
...
//echo $page;
 ...
 $listecategorie = $categorieC->AffichercategoriePaginer($page, $perpage);
  $totalP = $categorieC->calcTotalRows($perpage);
...
?>
                        ...
                        if(isset($_GET['recherche']))
                       {
                        ...
                        $listecategorie=$categorieC->recherche($search_value);
                        }
                        ?> 
                        ...
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th>nomcategorie</th>
                                <th>description</th>
                     <th colspan="2"><form method="get" action="Modifiercategorie.php" >
                            ...
                            ?>
                                <tr class="table-primary">
                                    ...
                                    <td><?PHP echo $row['descriptioncategorie']; ?></td>

                                    <td>
                                        <form method="POST" action="../../controller/supprimercategorie.php">
                                            <input type="submit" name="supprimer" value="supprimer" class="btn btn-danger">
                                            <input type="hidden" value=<?PHP echo $row['idcategorie']; ?> name="idcategorie">
                                        </form>
                                    </td>
                                    <td>
                                        <a  class="btn btn-primary" href="editcategorie.php?idcategorie=<?PHP echo $row['idcategorie']; ?>"> Modifier </a>
                                    </td>
                                </tr>
                            <?PHP
                            }
