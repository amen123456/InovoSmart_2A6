<?php require_once "C:/wamp64/www/Integration/controller/ajouterproduit.php"; ?>
...
//echo $page;
 ...
 $listeproduit = $produitC->AfficherproduitPaginer($page, $perpage);
  $totalP = $produitC->calcTotalRows($perpage);
...
?>
                        ...
                        if(isset($_GET['recherche']))
                       {
                        ...
                        $listeproduit=$produitC->recherche($search_value);
                        }
                        ?> 
                        ...
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th>image </th>
                                <th>description</th>
                     <th colspan="2"><form method="get" action="Modifierproduit.php" >
                            ...
                            ?>
                                <tr class="table-primary">
                                    ...
                                    <td><?PHP echo $row['nbrproduit']; ?></td>
                                    <td><img width="5000" src="../../back/produit/img/<?PHP echo $row['imageproduit']; ?> "> </td>
                                    <td><?PHP echo $row['descriptionproduit']; ?></td>

                                    <td>
                                        <form method="POST" action="../../controller/supprimerproduit.php">
                                            <input type="submit" name="supprimer" value="supprimer" class="btn btn-danger">
                                            <input type="hidden" value=<?PHP echo $row['idproduit']; ?> name="idproduit">
                                        </form>
                                    </td>
                                    <td>
                                        <a  class="btn btn-primary" href="editproduit.php?idproduit=<?PHP echo $row['idproduit']; ?>"> Modifier </a>
                                    </td>
                                </tr>
                            <?PHP
                            }
