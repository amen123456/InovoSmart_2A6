...
<form action="ajouterlivreur.php" method="post">
            ...
            <div class="col-md-12" >
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">affiche d'un livreur</li>
                </ol>
              </nav>
            </div>
 ...
 <?php
    ...
    switch ($type_tri) {
        case 'nom':
            $listelivreur = $livreurC->trinom();
            break;
        case 'prenom':
            $listelivreur = $livreurC->triprenom();
            break;
    }
    ?>
        ...
        <div class="col-xl-6 col-md-12"  >
          <div class="ms-panel ms-panel-fh" style="width:900px ; margin-left: 120px;"  >
            ...
            <form action="trilivr.php" method="GET" class="form-inline">
...
<td><form method="POST" action="MailingInvitation.php">
  <button type="submit" style="min-width: 10px" class="btn btn-primary "  >  <i class="flaticon-mail" > </i></button>
  <input type="hidden" value="<?PHP echo $row['Idlivreur']; ?>" name="Idlivreur">
   </form>
  </td>
