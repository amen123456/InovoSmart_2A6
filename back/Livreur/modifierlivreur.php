     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Livreur-page" class="collapse" aria-labelledby="Livreur-page" data-parent="#side-nav-accordion">
          <li> <a href="livreur.html">Ajouter Un livreur</a> </li>
          ...
          <div class="ms-panel ms-panel-fh" style="width:900px ; margin-left: 120px;"  >
            <div class="ms-panel-body"  >
              <form method="POST"  class="needs-validation clearfix" novalidate="">
                <div class="form-row">
                  <div class="col-xl-12 col-md-12 ">
                          <h5>modifier livreur</h5><br>

               <label>Idlivreur</label>
                  <div class="input-group">
                       <input type="number" name="Idlivreur" class="form-control" id="Idlivreur" placeholder="Entrer Idlivreur"  value="<?PHP echo $Idlivreur ?>">
              ...
              <label>Idlivraison</label>
                <div class="input-group">
                  <input type="number" name="Idlivraison" class="form-control" id="Idlivraison" placeholder="Entrer Idlivraison" value="<?PHP echo $Idlivraison ?>">
                  <div class="invalid-feedback">
                  </div>
                </div>
              ...
              <div class="col-md-12">
              <input type="submit" name="modifier" value="Modifier livreur!">
              </div>
...
if (isset($_POST['modifier'])){
  $livreur = new livreur($_POST['Idlivreur'],$_POST['Idlivraison'],$_POST['nom'],$_POST['prenom'],$_POST['email']);
  $livreurC->modifierLivreur($livreur,$_POST['Idlivreur']);
echo'<script>location.replace("afficherlivreur.php")</script>';  
}
}?>
