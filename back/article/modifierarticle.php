...
if (isset($_GET['id_article'])){
    $articleA=new ArticleA();
      $result=$articleA->recupererarticle($_GET['id_article']);
        ...
        <div class="col-xl-6 col-md-12"  >
          <div class="ms-panel ms-panel-fh" style="width:1000px ; margin-left: 120px;"  >
            <div class="ms-panel-body"  >
              ...
              <label>titre</label>
                <div class="input-group">
                  <input type="text" name="titre" class="form-control" id="titre" placeholder="Entrer le titre d'article" value="<?PHP echo $titre ?>">
                  <div class="invalid-feedback">
                  </div>
                </div>
              ...
              <div class="col-md-12">
              <input type="submit" name="modifier" value="Modifier article!">
              </div>
...
if (isset($_POST['modifier'])){
  $article = new article($_POST['id_article'],$_POST['titre'],$_POST['Description']);
  $articleA->modifierarticle($article,$_POST['id_article']);
echo'<script>location.replace("afficherArticle.php")</script>';  
}
}?>
