     ...
     <!-- gestion des produits/categories -->
      ...
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#Categorie-page" aria-expanded="false" aria-controls="Categorie-page">
          <span><i class='far fa-clipboard' style='font-size:18px;color:white'></i>Gestion Des Categories</span>
        </a>
        <ul id="Categorie-page" class="collapse" aria-labelledby="Categorie-page" data-parent="#side-nav-accordion">
          <li> <a href="../produit/AjouterCategorie.php">Ajouter Une Categorie</a> </li>
          <li> <a href="../produit/ModifierCategorie.php">Modifier  Une Categorie</a> </li>
     ...
     <!-- /gestion des articles/commentaires-->
      ...
      <li class="menu-item">
        ...
        <ul id="Article-page" class="collapse" aria-labelledby="Article-page" data-parent="#side-nav-accordion">
          <li> <a href="article.html">Ajouter Un Article</a> </li>
            ...
            <div class="col-md-12" >
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">affiche d'un article</li>
                </ol>
              </nav>
            </div>
...
<form action="triarti.php" method="GET" class="form-inline">
...
<form action="" method="post">
			<input class="input" type="text" name="titre" value="<?=$titre?>" placeholder="Recherche par titre" />
<button type="submit" style="min-width: 10px" class="btn btn-dark btn btn-pill"  name="filtrer"  ><i class="flaticon-search"> </i></button>
...
<button type="submit" style="min-width: 10px" class="btn btn-primary"  name="modifier"  ><i class="flaticon-excel"> </i></button>
 
  <input type="hidden" value="<?PHP echo $row['id_article']; ?>" name="id_article">
   </form>
  </td>
 
  <td><a href="modifierarticle.php?id_article=<?PHP echo $row['id_article']; ?>">
...
<button type="submit" style="min-width: 11px" class="btn btn-dark btn btn-pill" style="width:130px" >  <i class="flaticon-statistics" > </i></button>
   </form>  </td>
