     ...
     <!-- /gestion des articles/commentaires-->
      ...
      <li class="menu-item">
        ...
        <ul id="Article-page" class="collapse" aria-labelledby="Article-page" data-parent="#side-nav-accordion">
          <li> <a href="../eventetoffre/article.html">Ajouter Un Article</a> </li>
          
          <li> <a href="../eventetoffre/afficherarticle.php"> Afficher les Articles</a> </li>
...
//shipping stats...
  $req3= $db->query("SELECT id_article as id_article from article group by id_article");
  $req3->execute();
...
foreach ($liste3 as $row) {
   $dataPoints3[] = array('y'=> $row->id_article);
}
?>
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  title: {
    text: "Les articles qui ont un nombre des commentaires élevés"
  },
  data: [{
    type: "pie",
    startAngle: 240,
    yValueFormatString: "##0\"\"",
    indexLabel: "  ID Artile:{y}",
