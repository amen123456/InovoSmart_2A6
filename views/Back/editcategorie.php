<?php
include "../../controller/ajoutercategorie.php";
...
if (
    ...
    isset($_POST["descriptioncategorie"]) 
) {
    if (
        !empty($_POST["nomcategorie"]) &&
        !empty($_POST["descriptioncategorie"])

    ) {
        $categorie = new categorie(
            $_POST['nomcategorie'],
            $_POST['descriptioncategorie']
        ...
        <div role="tabpanel" class="tab-pane active fade show" id="activityLog">
          <ul class="ms-activity-log">
            <li>
              ...
              <span> <i class="material-icons">categorie</i>1 January, 2019</span>
            ...
            <li>
              ...
              <span> <i class="material-icons">categorie</i>4 March, 2018</span>
 ...
 <?php
                ...
                <form method="POST" action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="idcategorie" id="idcategorie" value="<?php echo $categorie['idcategorie']; ?>" disabled>
                                </div>

                                <div class="form-group">
                                    <label for="nomcategorie">nomcategorie</label>
                                    <input type="text" class="form-control" name="nomcategorie" id="nomcategorie" value="<?php echo $categorie['nomcategorie']; ?> ">
                                </div>
                                <div class="form-group">
                                    <label for="descriptioncategorie">descriptioncategorie</label>
                                    <textarea type="text" class="form-control" name="descriptioncategorie" ><?php echo $categorie['descriptioncategorie']; ?> </textarea>
                                </div>
