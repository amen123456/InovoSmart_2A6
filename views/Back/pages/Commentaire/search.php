    ...
    <nav class="navbar ms-navbar">
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
          <form class="ms-form" method="post" action="search.php">
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              ...
              <select name="search_by" id="search_by">
                <option value="cid">ID Commentaire</option>
                <option value="ProdID">ID Produit</option>
          ...
          <li class="ms-nav-item ms-search-form pb-0 py-0">
            <form action="AfficherCommentaire.php" method="post" style="margin-left: 10px;"><br>
...
$result = mysqli_query($link, "SELECT * FROM cmnt where $search_by = '$search'");
