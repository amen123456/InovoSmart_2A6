     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Notification-page" class="collapse" aria-labelledby="Notification-page" data-parent="#side-nav-accordion">
          ...
          <li> <a href="AfficherNotification.html"> Afficher les Notifications</a> </li>
    ...
    <nav class="navbar ms-navbar">
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        <li class="ms-nav-item ms-search-form pb-0 py-0">
          ...
          <form action="AfficherNotification.php" method="post" style="margin-left: 10px;"><br>
...
$result = mysqli_query($link, "SELECT * FROM notif where $search_by = '$search'");
