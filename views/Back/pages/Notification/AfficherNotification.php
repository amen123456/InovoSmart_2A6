...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="../../../Acceuil.php"> <img src="../../assets/img/dashboard/logo.png" alt="logo"> </a>
    </div>
     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Reclamation-page" class="collapse" aria-labelledby="Reclamation-page" data-parent="#side-nav-accordion">
          ...
          <li> <a href="../Reclamation/AfficherReclamation.php"> Afficher les réclamations</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="Notification-page" class="collapse" aria-labelledby="Notification-page" data-parent="#side-nav-accordion">
          <li> <a href="AjoutNotification.html">Ajouter Une Notification</a> </li>
          <li> <a href="ModifierNotification.html">Modifier Une Notification</a> </li>
          <li> <a href="SupprimerNotification.html">SupprimmerUne Notification</a> </li>
          <li> <a href="AfficherNotification.php"> Afficher les Notifications</a> </li>
          ...
          <form class="ms-form" method="post" action="search.php">
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              ...
              <select name="search_by" id="search_by">
                <option value="notifid">ID Notification</option>
                <option value="senderid">ID Sender</option>
                <option value="receiverid">ID Reciver</option>
...
<option value="notifID">ID Notification</option>
<option value="senderID">ID Sender</option>
<option value="receiverID">ID Receiver</option>
<option value="date">Date</option>
<option value="msg">Message</option>
</select>
<input type="submit" value="Trier" class="btn btn-primary w-5 mt-0 has-icon"><br><br>
</form>
    <?php
...
$result = mysqli_query($link, "SELECT * FROM notif");
