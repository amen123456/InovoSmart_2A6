...
<form action="AjouterUtilisateur.php" method="post">
  ...
  <div class="modal fade" id="notes-modal" tabindex="-1" role="dialog" aria-labelledby="notes-modal">
   ...
   <form method="GET" action="ajoutlivraison.php" enctype="multipart/form-data" >
            ...
            <div class="col-md-12" >
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Ajout d'une livraison</li>
                </ol>
              </nav>
            </div>
        ...
        <div class="col-xl-6 col-md-12"  >
          <div class="ms-panel ms-panel-fh" style="width:1000px ; margin-left: 120px;"  >
            <div class="ms-panel-body"  >
              <form class="needs-validation clearfix" novalidate="">
                <div class="form-row">
                  <div class="col-xl-12 col-md-12 ">
                          <h5>Ajout Livraison</h5><br>
         

                          
              <label for="nop">ID Utilisateur</label>
              
                <input type="number" name="id" class="form-control" id="id" placeholder="Entrer l'Id Utilisateur " required="">
                
              <label for="nom">Nom</label>
                
                  <input type="text" name="nom" class="form-control" id="nom" placeholder="Entrer Nom " required="">
                ...
                <label for="password">Password</label>
                    ...
                    <input type="text" name="password" class="form-control" id="password" placeholder="Entrer Password ">
              ...
              <div class="col-md-12">
                <button class="btn btn-dark mr-2  ms-graph-metrics"> <a href="Utilisateur.html">Vider </a> </button>
